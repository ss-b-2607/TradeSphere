        ...
        <div className="container  p-3">
           <div className="row  p-5">
               ...
               <div className="text-center mt-5">
                <Link to="/products" className="mx-5" style={{ textDecoration: "none" }}>Explore our products<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
</Link>   
                <Link to="/kite-demo"  style={{ textDecoration: "none" }}>Try Kite demo <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
</Link>
               </div>
             </div>
           </div>
